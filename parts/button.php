...
?>
<span class="plumage">
    <button class="plumage-button<?php echo $is_author ? ' user-is-author' : ''; ?><?php echo (get_current_user_id() && user_has_voted($post_id, get_current_user_id())) ? ' has-voted' : ''; ?>" data-id="<?php echo $post_id; ?>">
